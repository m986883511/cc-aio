...
class SambaConfigView(base_view.BaseConfigView):
    ...
    def save_config(self, button):
        group, keys = 'samba', ['default_share_path', 'default_user', 'default_password']
    ...
    def default_password_change_button_func(self, edit_obj: urwid.Edit, current_value):
        ...
        if not current_value.isascii():
            ...
            edit_obj.set_caption('')
            CONF.samba.default_password = current_value
                    ...
                    urwid.Padding(
                        urwid.Columns(
                            [
                                ...
                                urwid.AttrMap(my_widget.TextEdit("", CONF.samba.default_user, self.default_user_change_button_func), "editbx", "editfc"),
                            ]
                        ), left=8, right=10
                    ),
                ),
                    ...
                    urwid.Padding(
                        urwid.Columns(
                            [
                                ...
                                urwid.AttrMap(my_widget.TextEdit("", CONF.samba.default_password, self.default_password_change_button_func), "editbx", "editfc"),
                            ]
                        ), left=8, right=10
                    ),
                ),
