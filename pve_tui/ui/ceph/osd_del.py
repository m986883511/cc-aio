...
from pve_tui import ui, jm_data, exception
...
class DeleteOsdConsoleView(base_view.BaseConsoleView):
    ...
    def show(self):
        ...
        cmd = f'pve_cli ssh ssh-run-on-remote-via-popen {self.selected_hostname} "pve_cli disk remove-osds {self.selected_osd_name_string}"'
